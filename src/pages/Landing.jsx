      ...
      <section className="landing__hero">
        ...
        >
          ...
          <div className="landing__cta">
            ...
            <Link to="/app/dashboard" className="btn btn-secondary btn-lg">
              Посмотреть демо
            </Link>
          </div>
        ...
        <div className="features-grid">
          {features.map((f, i) => (
            ...
            >
              ...
              <h3>{f.title}</h3>
              <p>{f.text}</p>
              <Link to={f.link} className="link-btn">
      ...
      <section className="landing__how" id="how">
        ...
        <div className="landing__how-copy">
          ...
          <div className="landing__how-cta">
            ...
            <Link to="/mobile" className="btn btn-secondary">
              <Smartphone size={18} />
              Мобильная версия
            </Link>
          </div>
